...
class Meownime : ParsedAnimeHttpLegacySource() {
    ...
    override fun popularAnimeSelector(): String = "article, div.post, .hentry, div.animpost, div.bsx"
    ...
    override fun animeDetailsParse(document: Document): SAnime = SAnime.create().apply {
        ...
        thumbnail_url = document.selectFirst("div.thumb img, .entry-content img, .wp-post-image, .post-thumbnail img")
